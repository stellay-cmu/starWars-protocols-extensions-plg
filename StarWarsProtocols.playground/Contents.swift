...
//  func forceLightning() -> Bool { return true }
//}
// Create patterned protocols
// set default protocol functions with extension
// create protocols from extensions
// create individual structs with protocols
...
// final extension with jedi powers and general powers
extension Jedi{
  func introspection() -> String { return "Search your feelings." }
}
...
// final extension with sith powers and general powers
extension Sith{
  func forceChoke() -> Bool { return true }
  func forceLightning() -> Bool { return true }
...
struct MasterObiWan: Jedi{
  func introspection() -> String { return "These are not the droids you're looking for." }
}
